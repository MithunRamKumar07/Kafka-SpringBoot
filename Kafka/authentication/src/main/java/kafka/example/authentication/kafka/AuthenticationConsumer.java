...
public class AuthenticationConsumer {
    ...
    public void listenToDeadLetterQueue(){
        //Handle failure logic here. This can happen because of the Format errors, Invalid Data or what ever
        log.info("Failed events are pushed to DL Topic");
        // The messages in this queue can be handled by a consumer and can be
        // stored as reports for metrics and analysis
    }
